...
<div
  className="monitor-card-home"
  onClick={() => {
    loadStatus();
    setPage("monitor");
  }}
>
  <div className="monitor-icon-home">
    📊
  </div>
  ...
  <div className="stat-card">
    ...
    <div>
      ...
      <h3 className={serverOnline ? "online" : "offline"}>
  ...
  <div className="stat-card">
    ...
    <div>
      ...
      <h3 className={botConnected ? "online" : "waiting"}>
        {botConnected ? "Terhubung" : "Belum"}
      </h3>
  ...
  >
    ...
    <div>
      ...
      <h3>{sessions.length} Session</h3>

      <small>Perangkat Terhubung</small>
    </div>
  </div>
